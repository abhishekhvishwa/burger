        ...
        <section class="checkout-form">
            ...
            <form action="" method="post">
                ...
                <div class="flex">
                    ...
                    <div class="inputBox">
                        <span> <i class="fa fa-user"></i> your name</span>
                        <input type="text" placeholder="enter your name" name="name" required>
                    </div>

                    <div class="inputBox">
                        <span> <i class="fa fa-phone"></i> your number</span>
                        <input type="number" placeholder="enter your number" name="number" required>
                    </div>

                    <div class="inputBox">
                        <span> <i class="fa fa-envelope"></i> your email</span>
                    ...
                    <div class="inputBox">
                        <span> <i class="fa fa-home"></i> address line 1</span>
                        <input type="text" placeholder="ex. flat no." name="flat" required>
                    </div>

                    <div class="inputBox">
                        <span> <i class="fa fa-map"></i> address line 2</span>
                        <input type="text" placeholder="ex. street name" name="street" required>
                    </div>

                    <div class="inputBox">
                        <span> <i class="fa fa-city"></i> city</span>
                    ...
                    <div class="inputBox">
                        <span> <i class="fa fa-mail-bulk"></i> pin code</span>
